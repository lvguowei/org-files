...
**** Text Advanture Game
    ...
    *nodes* is called association list, or /alist/ in short.
    ...
    | WHISKY | BUCKET |
*** SICP
**** Data-directed programming example: Complex number
***** Multiple representations
****** Two representations:
       1. As a pair of =real-part= and =imag-part=
       2. As a pair of =magnitude= and =angle=
****** The selectors and constructors of the abstract complex number.
       #+BEGIN_SRC scheme
         ;; Selectors:
         (real-part z)
         (imag-part z)
...
****** Implementations of selectors that supports both representations.
       ...
       #+END_SRC
****** Predicate functions for recognizing rectangular and polar.
       #+NAME: predicates
       #+BEGIN_SRC scheme
         ...
         (define (polar? z)
           (eq? (type-tag z) 'polar))
       #+END_SRC
****** Selectors and constructors for rectangular.
       ...
       #+END_SRC
****** Selectors and constructors for polar.
...
****** Source Code
        ...
        #+BEGIN_SRC scheme :tangle complex_numbers.scm :noweb yes
          <<operations>>
          <<selectors>>
          <<predicates>>
